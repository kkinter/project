...
class Permission:
    ...
    Allows for easy comparison of difficult notations
    E.g. Permission("CREATE") == "CREATE".
    """

    permission_type: str

    def __init__(self, permission_type: str) -> str:
...
class PermissionType(str, Enum):
    """
    Enum for the diffrent types of default
    permissions that can be appied to a model.
